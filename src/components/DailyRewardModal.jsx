          ...
          <div className="modal-body">
            ...
            {!loading && status?.signed_in && (
              <>
                ...
                <div className="daily-reward-ladder">
                  {Array.from({ length: CYCLE_DAYS }, (_, i) => {
                    ...
                    return (
                      <div key={i} className={`daily-reward-chip ${isCurrent ? 'current' : ''} ${dayNum < todayDay ? 'done' : ''} ${bonus ? 'bonus' : ''}`}>
                        <span className="daily-reward-chip-day">Day {dayNum}</span>
                        <span className="daily-reward-chip-pts">+{baseForDay(dayNum)}</span>
                        {bonus && <span className="daily-reward-chip-bonus">👑 Pro</span>}
                      </div>
                    );
                  })}
                </div>
                ...
                {result && (
                  <div className="daily-reward-success">
                    <GiftGlyph size={28} />
                    <div>
                ...
                {/* Today's claim */}
                {todayPending ? (
                  <div className="daily-reward-card recover">
                    <div className="daily-reward-card-info">
                      <div className="daily-reward-card-title">Day {todayDay} · in review ⏳</div>
                      <div className="daily-reward-card-sub">
                  ...
                  <div className="daily-reward-card">
                    <div className="daily-reward-card-info">
                      <div className="daily-reward-card-title">Day {todayDay} reward</div>
                      <div className="daily-reward-card-sub">
                    ...
                    <div className="daily-reward-card-actions">
                      {shareRequired ? (
                  ...
                  <div className="daily-reward-card claimed">
                    <div className="daily-reward-card-info">
                      <div className="daily-reward-card-title">Claimed today ✓ (+{status.today_points_claimed} BP)</div>
                      <div className="daily-reward-card-sub">
                ...
                {adFeaturesOn && status.yesterday_recoverable && (
                  <div className="daily-reward-card recover">
                    <div className="daily-reward-card-info">
                      <div className="daily-reward-card-title">Missed yesterday?</div>
                      <div className="daily-reward-card-sub">

...
import { useAuth, useToast, ADMIN_USERNAMES, AI_TOOL_NAME_TO_ID, copyToClipboard, getModelForTool, getToolDisplayName, normalizeToolKey, formatTimeAgo, buildPostShareUrl } from '../../lib/appShared.js';
      ...
      <Helmet>
        ...
        <script type="application/ld+json">{JSON.stringify({
          ...
          "publisher": {
            ...
            "logo": { "@type": "ImageObject", "url": "https://prmpted.com/og-image.png" }
          },

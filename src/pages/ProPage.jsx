...
import ProAnalytics from '../components/pro/ProAnalytics.jsx';
  ...
  return (
    <div className="pro-page" style={pageStyle}>
      ...
      {hubTab === 'analytics' && hasAccess && (
        <section style={{ marginTop: 8 }}>
          <h2 style={h2Style}>Your post analytics</h2>
        ...
        <section style={sectionStyle} id="pro-plans">
          ...
          <div style={{ marginTop: 26, display: 'flex', gap: 18, flexWrap: 'wrap', alignItems: 'stretch' }}>
            <div style={planCard}>
              ...
              >
                {checkoutLoading === 'monthly' ? 'Starting checkout…' : 'Start Pro'}
              </button>
            </div>
            <div style={planCardInverse}>
              ...
              >
                {checkoutLoading === 'lifetime' ? 'Starting checkout…' : 'Get Lifetime'}
              </button>
            </div>
          </div>
        </section>
